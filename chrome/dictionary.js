...
//	["видит"+sya,"видеть"],//Бред
	...
	["престёг","пристёг"],
	["фармат","формат"],
	["ь[еи]д[еи]н(?=(е|ё|и|я|яе|яю)[вмнтшщ])","ъедин"],//Объединение
	["ъ[еи]д[еи]н(?=(е|ё|и|я|яе|яю)[вмнтшщ])","ъедин"],

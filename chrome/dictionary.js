...
*/
	...
	["ч[ёе]рт[\\s-]*воз[ъь]*ми","чёрт возьми"],
	...
	["по-круче","покруче"],
	["п[ао][\\s-]шуз*сь*ть*рее","пошустрее"],
	...
	["по[\\s-]*вежлевее","повежливее"],
	["по[\\s-]*мелочи","по мелочи"],
...
//	["светой","святой"],//TODO: склонять
	...
	["по-*пути","по пути"],
	["ск[ао]рее[\\s-]*вс[еи]го","скорее всего"],
	["на-*равных","на равных"],
...
*/
	...
	["много[\\s-]*п[ао]точ[ъь]*н","многопоточн"],
	["чесн*","честн"],
	["р[еи]гул+ир","регулир"],
	["докоз","доказ"],
	["дешов","дешёв"],
	["и[зс]чез","исчез"],
	["разьяренн","разъярённ"],
	["чес[\\s-]*т*н*о*е*[\\s-]*слово","честное слово"],

	["ц[иые]фр[ао]в","цифров"],
	["цыфр","цифр"],
	["растоян","расстоян"], // Но растаян (снег)
	["сум+ар+н","суммарн"],
...
//	["сь","съ"],//TODO: прочие приставки//Мэри Сью
	...
	["инфецир","инфицир"],
	["предст[оа](?=[ия])","предсто"],
	["предст[оа]в","представ"],
/*
	[""+sya,""],
	[""+sya,""],
*/

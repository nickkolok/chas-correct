...
*/
	...
	["по-круче","покруче"],
	["п[ао][\\s-]шу[зс]+ь*ть*рее","пошустрее"],
	...
	["п[ао][\\s-]*н[еи][\\s-]*мно[жш][ьъ]к[аоу]","понемножку"],
...
*/
	...
	["д[еи]л+[еия]ж+[еёо]м", "дележом"],
	["п[ао]дним[еи]т","поднимет"],
	["п[ао]дним[еи]т[ьъ]*ся","поднимется"],
	["пол[\\s-]+кило","полкило"],
	["пол[\- ]часа","полчаса"],
	["пол-*года","полгода"],
	["поллитра","пол-литра"],
...
*/
	...
	["р[ао]с+мотр","рассмотр"],
	["р[ао]с+матр","рассматр"],
	["европп","европ"],
	["и[зс]+ку[зс]+т*в","искусств"],
	...
	["пере[\\s-]продан","перепродан"],
	["рус+к[ао][\\s-]+[ея]зыч[ьъ]*н","русскоязычн"],
	["много-*п[ао]точ[ъь]*н","многопоточн"],
	...
	["выбиру","выберу"],
	["выбире","выбере"],
	["из[йьъ]*[еиыэ]мать","изымать"],
	["из[йьъ]*[еиыэ]ма[еи]т","изымает"],
	["из[йьъ]*[еиэ]маю","изымаю"],
	["из[йьъ]*[еиыэ]ма[еи]шь*","изымаешь"],
	["из[йьъ]*[еиыэ]ма[еи]м","изымаем"],
	["из[йьъ]*[еиыэ]мал","изымал"],
	["из[йьъ]*[еиыэ]май","изымай"],
	["из[йьъ]*[еиыэ]мая","изымая"],
	["из[йьъ]*[еиыэ]мавш","изымавш"],
	...
	["ад[ьъ]*[ую]нк*т", "адъюнкт"],
	["од[ьъ]*[ую]нк*т", "адъюнкт"],
	...
	["случ[ие](?![влнмстш])","случа"],//[aisse-258]: "случий" -> "случай", но не трогаем "случИлось"
	...
	["карабл","корабл"],
	["отсутсв","отсутств"],
	["окс[иёю]м[аои]р[ао]н","оксюморон"],
...
//	["сь","съ"],//TODO: прочие приставки//Мэри Сью
	...
	["егурт","йогурт"],
	["презнал","признал"],
	["т[еи]хнич[еи]*ст*к","техническ"],
	["инфецир","инфицир"],
	["предста(?=[ия])","предсто"],
	["предстов","представ"],
	["п[ъьй]й*[эе]з","пьез"],
	["эл[еэ]ктр[ие]к","электрик"],
/*
	[""+sya,""],
	[""+sya,""],
*/
	...
	["перепех","перепих"],
	["п[ао]д[ьъ]*[иы]тог","подытог"],
	["п[ао]д[ьъ]*[иы]тож[еи](?!н)","подытожи"],
	["п[ао]д[ьъ][иы]тож","подытож"],
	["п[ао]днима","поднима"],
	["п[ао]днима[еи]","поднимае"],
	["уеден","уедин"],
	["извен","извин"],
	["обворач","оборач"],
	["металич","металлич"],
...
*/
	...
	["п[реи][реи]п[еи]нд[еи]куляр","перпендикуляр"],
...
//	["видит"+sya,"видеть"],//Бред
	...
	["престёг","пристёг"],
	["фармат","формат"],
	["ь[еи]д[еи]н(?=(е|ё|и|я|яе|яю|л)[вмнтшщ])","ъедин"],//Объединение
	["ъ[еи]д[еи]н(?=(е|ё|и|я|яе|яю|л)[вмнтшщ])","ъедин"],
	["ь[еи]ден(?=[нис])","ъеден"],//Объедение
	["ъ[еи]ден(?=[нис])","ъеден"],
	["проблемм","проблем"],
	["пропоган","пропаган"],
	["коблук","каблук"],
	...
	["м[уао]д[еэы]*р+ат[аоэ]*р", "модератор"],
	...
	["к[ао]лб[ао]с","колбас"],
	["тормаз","тормоз"],
	["х[ао]р+[ао][кх]т[еиэ]р+","характер"],
	["кунскамер","кунсткамер"],
	["подрятчик","подрядчик"],
	["цыстерн","цистерн"],
	["благочист","благочест"],
	["ч[еи]ст*нок","чеснок"],
	["м[еи]л+[еи]грам+","миллиграмм"],

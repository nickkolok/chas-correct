...
*/
	...
	["случ[ие](?!л|т|м)","случа"],//[aisse-258]: "случий" -> "случай", но не трогаем "случИлось"
...
//	["ъед[еи]н","ъедин"],
	...
	["к[ао]лб[ао]са","колбаса"],
	["ч[ие]сл","числ"], //например, исчисление
	["ц[иы]пл[её]нок","цыплёнок"],
	["т[ие]л[ие]виз[аео]р","телевизор"],
	["мур[ао]в","мурав"], //муравей, муравьиный
	["инж[ие]нер","инженер"],
	["д[ие]скр[ие]м[ие]н","дискримин"], //дискриминант, дискриминация
	["б[ао]лкон","балкон"],
	["[ао]д[еы]кват","адекват"],
];

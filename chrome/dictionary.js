...
*/
	...
	["в-*сч[ёе]т","в счёт"],
	["в[-\\s]*случ[аеи][еи]","в случае"],
	["в[-\\s]*том[-\\s]*случ[аеи][еи]","в том случае"],
	["в[-\\s]*таком[-\\s]*случ[аеи][еи]","в таком случае"],
	["случ[ие]и","случаи"],
	["в-*виде","в виде"],
	["в-*порядке","в порядке"],
	["в-*целом","в целом"],
...
*/
	...
	["н[еи][ -]*в[ -]*ко[еи]м случ[аеи][еи]","ни в коем случае"],
...
*/
	...
	["агр[еи]с+","агресс"],
	["ко[еэ]ф+[ие]ц[ие][еэ]нт","коэффициент"],
	["с[ие]стем+","систем"],
	["сум(?=ир|арн)","сумм"],

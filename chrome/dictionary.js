...
*/
	...
	["в[\\s-]*кратце","вкратце"],
	["в кратце","вкратце"], //TODO: почистить
	["в кратце","вкратце"], //[Katzen Gott]: дубликаты пока не убираю, чтобы можно было сверить кол-во строк
	["во-время","вовремя"],

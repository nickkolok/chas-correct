var testDictionary = [
    ...
    ["такомже", "таком же"],
    ["такогоже", "такого же"],
    //["чеголь",""], //возможно, это деревня, посёлок или что-то еще, гугл на это намекает
    //["чемуль",""], //а это персонаж игры Легенда: Наследие Дракона, так гугл говорит
    ["какомута", "какому-то"],
    ["какимта", "каким-то"],
    ["какойта", "какой-то"],
    ["какаята", "какая-то"],
    ...
    ["счас", "сейчас"],
    //["подругому",""], //два варианта, раздельно и с дефисом
    ["черезчур", "чересчур"],
    ["ничерта", "ни черта"],
    ["какбы", "как бы"],
    ["вкурсе", "в курсе"],
    ...
    */
    ...
    //последнее внесённое слово - строка 556 в tests.html
];

var testDictionary = [
    ...
    ["какая-ж", "какая ж"],
    ["какой-ж", "какой ж"],
    ["новых какихто вещей","новых каких-то вещей"],
    ["не нашла какихто нарушений","не нашла каких-то нарушений"],
    ["какихто специфичных","каких-то специфичных"],
    ["скинишь", "скинешь"],
    ["кинишь", "кинешь"],
    ["потеряеш", "потеряешь"],
    ["остаеца", "остаётся"],
    ...
    ["в-течение", "в течение"],
    ["втечении", "в течение"],
    ["не только из-за расчлененки, а вцелом", "не только из-за расчлененки, а в целом"],
    ["выгледиш", "выглядишь"],
    ...
    ["манеты", "монеты"],
    ["металы", "металлы"],
    ["много-поточная закачка файлов","многопоточная закачка файлов"],
    ["мылостыню", "милостыню"],
    ...
    */
	...
	["обьявить конструктор","объявить конструктор"],
	["обьявили","объявили"],
	["какихто","каких-то"],
	["много-поточная","многопоточная"],
	["позволяет ехать вдолг","позволяет ехать в долг"],
	["напорядок больше","на порядок больше"],
	["по-тихоньку пишу","потихоньку пишу"],
	["0.9 милиграмма","0.9 миллиграмма"],
	["регуллируемая поддержка спины","регулируемая поддержка спины"],
	["отрегуллировать","отрегулировать"],
	["приимущество перед классами","преимущество перед классами"],
	["не до-конца","не до конца"],
	["стестняйтесь","стесняйтесь"],
	["чёрт-возьми","чёрт возьми"],
	["когдато","когда-то"],
	["соеденили","соединили"],
	["докозательство","доказательство"],
	["ездяют","ездят"],
    ["само-собой","само собой"],
	["обьелся","объелся"],
	["превести","привезти"],
	["соответсвует","соответствует"],
	["повежлевее","повежливее"],
	["овощь","овощ"],
	["переобьяснять","переобъяснять"],
	["непомню","не помню"],
	["досихпор","до сих пор"],
	["видите-ли","видите ли"],
	["дешовое","дешёвое"],
	["ужастно","ужасно"],
	["изчезновения","исчезновения"],
	["скорее-всего связана","скорее всего связана"],
	["помелочи","по мелочи"],
	["скорее-всего","скорее всего"],
	["разьяренная","разъярённая"],
	["по-ближе","поближе"],
	["разьве","разве"],
	["вычеслительных","вычислительных"],
	["прогрес","прогресс"],
	["на-равных","на равных"],
	["горантией","гарантией"],
	["разобъёте","разобьёте"],
	["приступление","преступление"],
	["соеденил","соединил"],
	["предлогать","предлагать"],
	["агресивно","агрессивно"],
	["фирминный","фирменный"],
	["какуюнибудь","какую-нибудь"],
	["ужастная","ужасная"],
	["истолковон","истолкован"],
	["плечё","плечо"],
	["по-ошибке","по ошибке"],
	["интелекта","интеллекта"],
	["гостиприимные","гостеприимные"],
	["cьели","cъели"],
	["объеденили","объединили"],
	["и чуть чуть по ощущениям меньше стиля","и чуть-чуть по ощущениям меньше стиля"],
	["чуть чуть","чуть-чуть"],
	["чуть чуть притормаживают","чуть-чуть притормаживают"],
	["все-такое","всё такое"],
	["всё-такое","всё такое"],
	["какойнить","какой-нибудь"],
	["какойнибудь","какой-нибудь"],
	["вычеслений","вычислений"],
	["подьем","подъём"],
	["по-ошибке","по ошибке"],
	["растоянии","расстоянии"],
	["притензии","претензии"],
	["обьявить","объявить"],
	["так-как","так как"],
	["ограничевается","ограничивается"],
	["если-бы","если бы"],
	["сьел","съел"],
	["обьеденили","объединили"],
	["чес-слово","честное слово"],
	["непомню","не помню"],
	["исчесляемыми","исчисляемыми"],
	["обьединять","объединять"],
	["предьявили","предъявили"],
	["тока-что","только что"],
	["обьелась","объелась"],
	["разьяренная толпа обманутых","разъярённая толпа обманутых"],
	["притензий к ним не имею","претензий к ним не имею"],
	["притензий","претензий"],
	["извесной","известной"],
	["както работает","как-то работает"],
	["както","как-то"],
    /*
      ["",""],
      ["",""],
